...
func TestImagePluginVersion(t *testing.T) {
	tests := []struct {
		...
		{"tagged image", "ghcr.io/openclaw/openclaw:2026.7.1", "2026.7.1", false},
		{"slim tag", "ghcr.io/openclaw/openclaw:slim", "", false},
		{"latest tag", "ghcr.io/openclaw/openclaw:latest", "", false},
		{"slim variant with arch", "openclaw:2026.7.1-slim-arm64", "2026.7.1", false},
		{"slim variant without arch", "openclaw:2026.7.1-slim", "2026.7.1", false},
